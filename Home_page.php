...
<div class="header" id="topheader" >
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <a class="navbar-brand font-weight-bold text-white logo" href="index.html"><mark style="background-color: blueviolet;">C</mark>odingHub</a>
  ...
  <li class="nav-item">
    <a class="nav-link" style="font-weight: 900;" href="http://localhost:3000/index.php">LOGOUT</a>
</li>
          </ul> 
        </div>
        </div>
      ...
      <div class="col-log-8 col-md-8 col-10 offset-lg-2 offset-md-2 col-1">
        <form action="/action_page.php">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" placeholder="Enter Mobile No:" id="mobileno">
          </div>

          <div class="form-group">
  
            <textarea class="form-control" rows = "5" placeholder = "Enter your message: "id="commnts"></textarea>
